...
TYPE_DATA_POSITIVE = [
    ...
    [str, False, "1", None],
    [int, True, '123', "current value \"123\" is not <class 'int'>"],
    [bool, True, 1, "current value 1 is not <class 'bool'>"],
    [str, True, [1], "current value [1] is not <class 'str'>"],
]
TYPE_DATA_NEGATIVE = [
    [str, ["1"]],
    [type, 123],
